                                            ...
                                            <table class="table m-0 table-colored-bordered table-bordered-primary">
                                                ...
                                                if ($rowcount == 0) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="7" align="center"><h3 style="color:red">No record
                                                                                                             found</h3>
                                                        </td>
                                                    <tr>
                                                    <?php
                                                    ...
                                                    while ($row = mysqli_fetch_array($query)) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="edit-subcategory.php?scid=<?php echo htmlentities($row['subcatid']); ?>"><i
                                                                            class="fa fa-pencil"
                                                ...
                                                if ($rowcount == 0) {
                                                    ...
                                                    while ($row = mysqli_fetch_array($query)) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo htmlentities($row['subcatupdationdate']); ?></td>
                                                            <td>
                                                                <a href="manage-subcategories.php?resid=<?php echo htmlentities($row['subcatid']); ?>"><i
