...
if (strlen($_SESSION['login']) == 0) {
    ...
    <head>
        ...
        <!-- App title -->
        <title>Mobile Review | Manage Posts</title>
                                        ...
                                        <table class="table table-colored table-centered table-inverse m-0">
                                            ...
                                            if ($rowcount == 0) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="4" align="center"><h3 style="color:red">No record
                                                                                                         found</h3></td>
                                                <tr>
                                                <?php
                                            } else {
                                                while ($row = mysqli_fetch_array($query)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="edit-post.php?pid=<?php echo htmlentities($row['postid']); ?>"><i
                                                                        class="fa fa-pencil"
